...
def main():
    ...
    if dataset_name == "cifar10":
        ...
        model = net.__dict__[args.arch](num_classes=args.num_classes, norm_layer=norm_layer, stem=stem,
                                        dct_ratio_low=args.dct_ratio_low, dct_ratio_high=args.dct_ratio_high,
...
def test_c(test_data, model, criterion, epoch, use_cuda):
    ...
    for corruption in CORRUPTIONS:
        ...
        test_data.targets = torch.LongTensor(np.load(os.path.join(args.data + "-c", 'labels.npy')))
